...
const RealizationDetailPage: NextPage = () => {
  ...
  return (
    <div>
      <PageHeader
        title={`Реализация ${realization.realization_number || realization.shipping_number}`}
        showBackButton
      ...
      <div className="space-y-6 print:space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div>
            ...
            <div className="font-medium">{realization.realization_number || realization.shipping_number}</div>
          </div>
          
          <div>
            <span className="text-sm text-gray-500">Дата отгрузки:</span>
            <div className="font-medium">{formatDate(realization.shipped_at)}</div>
          </div>
        ...
        <div>
          <h3 className="text-lg font-medium text-gray-900 mb-4">
            Позиции ({realization.items.length})
          </h3>
